...
class PlayerX:
    ...
    def player_move(self):
        ...
        """
        self.pick_position = int(input(f"Please player 1 make a move (1-9): "))
    ...
    def check_game_on_x(self):
        """
        Checks if player 1 has won or not and if the player won it increases the score by 1 and returns True
        """
